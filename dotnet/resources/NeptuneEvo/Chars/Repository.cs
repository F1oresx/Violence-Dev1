 ...
 */
        ...
        public static IReadOnlyDictionary<ItemId, ItemsInfo> ItemsInfo = new Dictionary<ItemId, ItemsInfo>()
        {
            ...
            { ItemId.Leg, new ItemsInfo("Штаны", "Не дадут тебе замёрзнуть.", "inv-item-shorts", "Одежда", NAPI.Util.GetHashKey("q_box_pt"), 1, new Vector3(0.0,0.0,-1.02), new Vector3(), newItemType.Clothes) },

            { ItemId.Bag, new ItemsInfo("Сумка", "Позволяет переносить в себе любые предметы.", "inv-item-backpack", "Одежда", NAPI.Util.GetHashKey("prop_cs_heist_bag_02"), 1, new Vector3(0, 0, -1.02), new Vector3(), newItemType.Clothes) },
            { ItemId.Feet, new ItemsInfo("Обувь", "Современная модель, которая никогда тебя не подведёт.", "inv-item-sneakers", "Одежда", NAPI.Util.GetHashKey("q_box_sh"), 1, new Vector3(0.0,0.0,-1.02), new Vector3(), newItemType.Clothes) },
            { ItemId.Jewelry, new ItemsInfo("Аксессуар", "Позволяет улучшить внешний вид персонажа.", "inv-item-necklace", "Одежда", NAPI.Util.GetHashKey("q_box_m"), 1, new Vector3(0.0,0.0,-1.02), new Vector3(), newItemType.Clothes) },
            { ItemId.Undershit, new ItemsInfo("Нижняя одежда", "Может быть надета под верхней одеждой, придаёт стильный вид твоему персонажу.", "inv-item-shirt", "Одежда", NAPI.Util.GetHashKey("q_box_cur"), 1, new Vector3(0.0,0.0,-1.02), new Vector3(), newItemType.Clothes) },
            { ItemId.BodyArmor, new ItemsInfo("Бронежилет", "Служит средством защиты персонажа, способен впитать 100 урона, прежде чем сломается.", "inv-item-armor", "Одежда", 701173564, 1, new Vector3(0.0,0.0,-1.02), new Vector3(90, 90, 0), newItemType.Clothes) },
            ...
            { ItemId.Top, new ItemsInfo("Верхняя одежда", "Может быть надета над нижней одеждой, придаёт стильный вид твоему персонажу.", "inv-item-jacket", "Одежда", NAPI.Util.GetHashKey("q_box_cur"), 1, new Vector3(0.0,0.0,-1.02), new Vector3(), newItemType.Clothes) },
            { ItemId.Hat, new ItemsInfo("Головной убор", "Спасёт тебя от солнечного удара в жаркий день.", "inv-item-cap", "Одежда", NAPI.Util.GetHashKey("q_box_hat"), 1, new Vector3(0.0,0.0,-1.02), new Vector3(), newItemType.Clothes) },
            { ItemId.Glasses, new ItemsInfo("Очки", "Защищат от солнца в самый солнечный день.", "inv-item-glasses", "Одежда", NAPI.Util.GetHashKey("q_box_m"), 1, new Vector3(0.0,0.0,-1.02), new Vector3(), newItemType.Clothes) },
            { ItemId.Bracelets, new ItemsInfo("Браслет", "Позволяют улучшить внешний вид персонажа.", "inv-item-bracelet", "Одежда", 2329969874, 1, new Vector3(0.0,0.0,-1.02), new Vector3(), newItemType.Clothes) },
            { ItemId.Watches, new ItemsInfo("Часы", "Показывает статусность твоего персонажа.", "inv-item-clock", "Одежда", 2329969874, 1, new Vector3(0.0,0.0,-1.02), new Vector3(), newItemType.Clothes) },
