...
mp.events.add("render", () => {
	...
	if (mp.game.controls.isDisabledControlPressed(2, 237) && mp.gui.cursor.position[0] > safeZone && mp.gui.cursor.position[0] < mp.game.graphics.getScreenActiveResolution(100, 100).x - safeZone) {
