...
mp.game.app.createBrowser('cef', `http://package/cef/index.html`, false);

mp.events.add("browserDomReady", (browser) => {
    let interface = mp.game.app.getBrowserObject("cef");
    if (interface == null || interface.rageBrowser !== browser) return;
    mp.events.call("client.initt");
});

var spawnEvent = new mp.Event("playerSpawn", (player) => {
...
mp.events.add("client.initt", async () => {
    mp.events.call("client.intro.start");
});